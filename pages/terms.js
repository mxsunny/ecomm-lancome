      ...
      <section className="text-gray-600 body-font">
        <div className="text-black-600 mx-2 md:mx-10 my-2 py-24">
          ...
          <p className="px-10 py-2">
            ...
            of LANCOME&#39s Website, located at www.LANCOME.COM. By accessing this
            website we assume you accept these terms and conditions. Do not continue
            to use LANCOME.COM if you do not agree to take all of the terms and
            conditions stated on this page. The following terminology applies to these
            Terms and Conditions, Privacy Statement and Disclaimer Notice and all
            Agreements: &quotClient&quot, &quotYou&quot and &quotYour&quot refers to you, the person log on
            this website and compliant to the Company’s terms and conditions. &quotThe
            Company&quot, &quotOurselves&quot, &quotWe&quot, &quotOur&quot and &quotUs&quot, refers to our Company.
            &quotParty&quot, &quotParties&quot, or &quotUs&quot, refers to both the Client and ourselves. All
          ...
          <p className="px-10 py-2">
            We employ the use of cookies. By accessing LANCOME.COM, you agreed to
            use cookies in agreement with the LANCOME&#39s Privacy Policy. Most
            interactive websites use cookies to let us retrieve the users details for
          ...
          <p className="px-10 py-2">
            Unless otherwise stated, LANCOME and/or its licensors own the
            intellectual property rights for all material on LANCOME.COM. All
            intellectual property rights are reserved. You may access this from
            LANCOME.COM for your own personal use subjected to restrictions set in
            these terms and conditions.
          </p>
          <div>
            <p className="mb-4 mx-10 font-semibold">You must not:</p>
            <li className="ml-10">Republish material from LANCOME.COM</li>
            <li className="ml-10">
              Sell, rent or sub-license material from LANCOME.COM
            </li>
            <li className="ml-10">
              Reproduce, duplicate or copy material from LANCOME.COM
            </li>
            <li className="ml-10">Redistribute content from LANCOME.COM</li>
          </div>
          ...
          <p className="mx-10 my-2 ">
            ...
            opinions and information in certain areas of the website. LANCOME does
            ...
            LANCOME,its agents and/or affiliates. Comments reflect the views and
            opinions of the person who post their views and opinions. To the extent
            permitted by applicable laws, LANCOME shall not be liable for the
            ...
            Comments on this website. LANCOME reserves the right to monitor all
          ...
          <div>
            ...
            <p className="mx-10 my-2">
              {" "}
              You hereby grant LANCOME a non-exclusive license to use, reproduce,
          ...
          <p className="px-10 py-2">
            ...
            hyperlink compensates the absence of LANCOME; and (d) the link is in the
            context of general resource information. These organizations may link to
            our home page so long as the link: (a) is not in any way deceptive; (b)
            does not falsely imply sponsorship, endorsement or approval of the linking
            party and its products or services; and (c) fits within the context of the
            ...
            inform us by sending an e-mail to LANCOME. Please include your name,
            your organization name, contact information as well as the URL of your
            site, a list of any URLs from which you intend to link to our Website, and
            a list of the URLs on our site to which you would like to link. Wait 2-3
          ...
          <div>
            ...
            <p className="ml-10 mt-4">
              No use of LANCOME&#39s logo or other artwork will be allowed for linking
          ...
          <p className="px-10 py-2">
            ...
            <br />
            In case the order is cancelled, 100% refund will be issued to the customer
            We reserve the right to limit or prohibit orders that, in our sole
            judgment, appear to be placed by dealers, resellers or distributors.
            <br />
            We shall not be liable for delay or failure to perform our obligations
            under these Terms if such delay or failure is due to any cause or
            conditions beyond our reasonable anticipation or control
            <br />
            Such causes or conditions shall include, without limitation, acts of God
            or of the public enemy, acts of any government or any authority or public
            body thereof in either their sovereign or contractual capacity, strikes,
            refusal or inability of a common carrier to provide communications
            capabilities (for example, but not limited to, internet services, email
            services, telephone and messaging services), shortages of labour, energy
            or materials, freight embargoes, delays in transportation, unusually
            severe weather, earthquake, flood, fire, notified epidemic resulting in
            lockdown of the area of Our offices, or resulting in the closure of our
            office(s) whether by the order of the authorities or as a matter of
            abundant caution on our part, valid court order, or any delay or failure
            to perform by any supplier or sub-contractor resulting from any of the
            above or other circumstances beyond our reasonable control and against
            which we could not reasonably have protected ourselves, such events
            constituting a condition of Force Majeure. We will attempt to notify you,
            on best-effort basis, at the earliest practicable time, identifying the
            Force Majeure event, the date of its occurrence and the tentative date up
            to which the Force Majeure event is expected to continue; however, such
            notification is not a necessary pre-condition to the event being
            identifiable as a Force Majeure event and the tentative date is not an
            assurance or binding on us, and is provided only as a goodwill gesture.
            <br />
            Our obligations under these Terms shall cease for the period of Force
            Majeure, and shall resume on the date such Force Majeure event actually
            ends, whether or not this is the same as the tentative date.
          </p>
